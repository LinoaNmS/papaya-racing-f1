...
class StandingListTile extends StatelessWidget {
  ...
  factory StandingListTile.forDriver({
    Key? key,
    required String teamName,
    required String country,
    required int standingRanking,
    required F1TeamColors colorAccent,
    required int points,
    required int racesWon,
    required String driverName,
  }) {
    return StandingListTile._(
      key: key,
      teamName: teamName,
      country: country,
      standingRanking: standingRanking,
  ...
  factory StandingListTile.forConstructor({
    Key? key,
    required String teamName,
    required String country,
    required int standingRanking,
...
class _DetailsStanding extends StatelessWidget {
  final String? driverName;
  final String teamName;
  final String driverCountry;

  const _DetailsStanding({
